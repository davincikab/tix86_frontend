  ...
  return (
    <div className='w-full h-full relative overflow-x-hidden '>
        ...
        <div className="dashboard-layout relative h-full">
            <button data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" className="inline-flex items-center p-2 mt-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden hover:bg-[#096eb7] focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
            ...
            <aside id="default-sidebar" className="absolute  top-0 left-0 z-40 w-64 bottom-0 transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
