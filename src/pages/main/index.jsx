...
const MainPage = () => {
  ...
  const handleClick = (event) => {
    if(event.features.length) {
      ...
      if(streets.find(street => street.name == feature.properties.SL)) {
        removeStreet(streets.find(street => street.name == feature.properties.SL));
        return;
      }
        ...
        <div className="px-4 py-2">
            ...
            : ""}
          {
            streets.map(entry => {
              ...
              return (
                <div key={entry.name} className="w-full my-2 text-gray-900 bg-white border border-gray-200 rounded-lg">
                  <div className="relative inline-flex items-center justify-between w-full px-4 py-2 text-sm font-sm border-b border-gray-200 rounded-t-lg hover:bg-gray-100 hover:text-blue-700 focus:z-10 focus:ring-2 focus:ring-blue-700 focus:text-blue-700 ">
        ...
        <div className="subescription-option px-4 py-2">
          ...
          <div className="my-1">
            <label className="inline-flex items-center mb-0 cursor-pointer" htmlFor='email_notification'>
              ...
              <div className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300  rounded-full peer  peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all  peer-checked:bg-[#0163AA]"></div>
              <span className="ms-3 text-sm font-medium text-gray-900 ">Email Notification</span>
            </label>
          </div>
          ...
          <div className="my-1">
            <label className="inline-flex items-center mb-0 cursor-pointer" htmlFor='twelve_hours'>
              ...
              <div className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300  rounded-full peer  peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all  peer-checked:bg-[#0163AA]"></div>
              <span className="ms-3 text-sm font-medium text-gray-900 ">Twelve Hours</span>
            </label>
          </div>
          ...
          <div className="my-1">
            <label className="inline-flex items-center mb-0 cursor-pointer" htmlFor='one_hour'>
              ...
              <div className="relative w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-300  rounded-full peer  peer-checked:after:translate-x-full rtl:peer-checked:after:-translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:start-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:w-5 after:h-5 after:transition-all  peer-checked:bg-[#0163AA]"></div>
              <span className="ms-3 text-sm font-medium text-gray-900 ">One Hour</span>
            </label>
          </div>
          ...
          <button
              onClick={onSubmit}
              className='my-2 rounded-[30px] font-bold bg-[#0163aa] disabled:bg-[#0163aa]/60 disabled:border-[#2c6353]/60 disabled:text-[#ddd]/60  p-3  w-full text-white cursor-pointer'
